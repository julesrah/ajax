...
<body>
    ...
    <div id="customers" class="container">
        ...
        <button type="button" class="btn btn-info btn-lg" id="item">Item<span class="glyphicon glyphicon-plus"
    ...
    <div id="items" class="container">
        ...
        <button type="button" class="btn btn-info btn-lg" id="customerbtn">Customer<span class="glyphicon glyphicon-plus"
                aria-hidden="true"></span></button>
